...
import { Mail, Lock, Eye, EyeOff, User, GraduationCap, Calendar, AlertCircle, Loader2, CheckCircle2, ArrowLeft, X } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400">Sign up to share and read experiences</p>
          </div>
