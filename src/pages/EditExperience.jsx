  ...
  useEffect(() => {
    async function fetchExperience() {
      try {
        ...
        // Check if company/role is in the predefined list
        const isCustomCompany = !COMPANIES.includes(data.company);
        const isCustomRole = !ROLES.includes(data.role);
        
        setFormData({
          company: isCustomCompany ? 'Other' : data.company,
          customCompany: isCustomCompany ? data.company : '',
          role: isCustomRole ? 'Other' : data.role,
          customRole: isCustomRole ? data.role : '',
          year: data.year || '',
        ...
        >
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Update your interview experience details
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Share your complete interview experience in detail..."
                  rows={8}
