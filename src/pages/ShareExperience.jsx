  ...
  return (
    <div className="page-bg py-8">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div>
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Share Your Interview Experience</h1>
            <p className="text-gray-600 dark:text-gray-400">Help others prepare for their interviews</p>
          </div>
